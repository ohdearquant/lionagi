...
class TestCalculateChatitem:
    """_calculate_chatitem passes raw tokenizer + model_name to tokenize(), which resolves encoding_name first."""
...
class TestCalculateEmbedItem:
    """_calculate_embed_item passes only tokenizer= (no encoding_name); decoder created from fallback encoding."""
...
class TestTokenizeStandalone:
    """tokenize() without a pre-built tokenizer resolves encoding_name via get_encoding_name and creates both tokenizer and decoder."""
