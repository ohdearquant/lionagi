...
class CodeForm(ActionForm):
    ...
    assignments: str = "sentence, language, guidance_response -> reason, action_needed, actions, answer"
    code: str | None = Field(None)
    
    def __init__(self, sentence=None, instruction=None, confidence_score=False, task=None, **kwargs):
        super().__init__(sentence=sentence, instruction=instruction, confidence_score=confidence_score,**kwargs)
        if task:
