...
- **Observable** (`protocols/_concepts.py`): Nominal ABC — Pile admission requires `isinstance(item, Observable)`, i.e. inheritance, not just an `id` attribute. `Element` inherits it directly.
