...
workflow. Users install them in `~/.lionagi/playbooks/` and invoke them with
...
| `model` | str | positional | Model spec: `claude-code/opus-4-6`, `claude-code/sonnet-4-6`, `codex/gpt-5.4`. |
...
Before declaring a playbook ready:
