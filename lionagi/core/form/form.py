...
class Form(BaseComponent):
    sentence: str = Field(
        default_factory=str, description="The sentence that describes the prompt."
    )
    ...
    def _validate_field(self, k, v, choices=None, keys=None, fix_=False, codes=False, **kwargs):
        ...
        if "lionagi.core.form.action_form.actionrequest" in str_:
            self.__setattr__(k, validation_funcs["action"](v, codes=codes))
            return True
