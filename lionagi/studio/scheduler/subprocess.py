...
async def spawn_and_wait(
    ...
    *deadline_seconds* defaults to the validated global/per-action-kind Studio
    setting. Expiry terminates the owned process group before raising
    :class:`SubprocessDeadlineExceededError`.
    """
