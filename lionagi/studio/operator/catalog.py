...
OPERATOR_MODEL_CATALOG: tuple[OperatorModelSpec, ...] = (
    ...
    OperatorModelSpec("claude-opus-5", "Claude Opus 5", "claude_code"),
    OperatorModelSpec("claude-sonnet-5", "Claude Sonnet 5", "claude_code"),
    ...
    OperatorModelSpec("deepseek-flash", "DeepSeek Flash", "codex"),
    OperatorModelSpec("kimi-code", "Kimi Code", "codex"),
