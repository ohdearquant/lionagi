...
_LAZY_MAP: dict[str, tuple[str, str | None]] = {
    "OllamaChatEndpoint": ("chat", None),
    "OllamaEmbedEndpoint": ("embed", None),
    "OllamaEmbedRequest": ("embed", None),
    "OllamaGenerateEndpoint": ("generate", None),
    "OllamaGenerateRequest": ("generate", None),
