...
describe("messages — leaf-key parity across all 16 locales", () => {
  // 1101 = 1059 + operator.composer.autoAllow (1) + the Library hooks surface
  ...
  // + the bounded Run Detail file surface (9 history.detail.file* leaves for
  // its filters, recent-window status, privacy note and preview labels).
